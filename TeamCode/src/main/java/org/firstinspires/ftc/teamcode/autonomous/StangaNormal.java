...
//
        ...
        if (timer.seconds() > 4.5) {
            telemetry.addLine("enough time... going to stack");
            telemetry.update();
...
//                    intake.paConOutside(63);
                    intakeVechi.paConInterpolateThread(100, 0, 0.45, 200, 22);
                    intakeVechi.paConInside(500);
                })

                .UNSTABLE_addTemporalMarkerOffset(0.4, () -> {
                    lifter.setTargetTicks(1500, Lifter.LIFTER_LEVEL.HIGH.ticks);
                    intakeVechi.swingSetTargetTicks(600, IntakeVechi.INTAKE_STATE.INSIDE.ticks);
...
//                .setAccelConstraint(new ProfileAccelerationConstraint(30))
                ...
                .lineToLinearHeading(new Pose2d(-26.7, -1.5, Math.toRadians(227)))
    ...
    TrajectorySequence toConeOne(@NonNull TrajectorySequence toHighPreload) {
        return drive.trajectorySequenceBuilder(toHighPreload.end())
                .UNSTABLE_addTemporalMarkerOffset(0.7, () -> {
                    ...
                    lifter.setTargetTicks(700, Lifter.LIFTER_LEVEL.LOW.ticks - 200);

                    lifter.setTargetTicks(1800, Lifter.LIFTER_LEVEL.LOW.ticks - 850);
...
//                .splineToConstantHeading(new Vector2d(-57.5, -12), Math.toRadians(180))
                ...
                .lineToConstantHeading(new Vector2d(-59.5, -11))
