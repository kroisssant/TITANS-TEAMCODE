...
public class DriveManual extends LinearOpMode {
    ...
    private void handleAutomizedControl(ControllerInput _controller) {
        ...
        if(_controller.dpadUp()){
            intake.setPowSwing(0.8);
        } else if (_controller.dpadDown()){
            intake.setPowSwing(-0.8);
        } else {
            intake.setPowSwing(0);
        }
...
//        }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        intake = new IntakeVechi(hardwareMap, false);
        ...
        while(opModeIsActive()){
            ...
            controller1.update();
            controller2.update();
            telemetry.addData("intake target: ", intake.currentTargetTicks);
            telemetry.addData("intake pos: ", intake.motorIntake.getCurrentPosition());
            telemetry.update();
