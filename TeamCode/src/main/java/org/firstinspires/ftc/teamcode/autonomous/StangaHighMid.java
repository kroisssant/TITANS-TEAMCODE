...
//                    intake.paConOutside(63);
                    intake.paConInterpolateThread(70, 0, 0.45, 200, 22);
                    intake.paConInside(500);
                })

                .UNSTABLE_addTemporalMarkerOffset(0.4, () -> {
                    lifter.setTargetTicks(1500, Lifter.LIFTER_LEVEL.HIGH.ticks);
                    intake.swingSetTargetTicks(600, IntakeVechi.INTAKE_STATE.INSIDE.ticks);

                    currentLifterState = Lifter.LIFTER_LEVEL.HIGH;
                    currentIntakeState = IntakeVechi.INTAKE_STATE.INSIDE;

                    intake.spinFor(3000, 800, 0.6);
                })
...
//
//                .lineToLinearHeading(new Pose2d(-26.7, -1.8, Math.toRadians(227)))
//
//                .resetConstraints()
